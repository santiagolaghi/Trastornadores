const CACHE='tnt-v12-global-fix';
const CORE=['/','/index.html','/manifest.webmanifest','/icons/icon.svg','/supabase-lite.js?v=12','/assets/tnt-ui.css?v=10','/assets/tnt-core.js?v=10','/assets/tnt-module-theme.css?v=10','/organizacion/','/campamento/','/glosario/','/lista-sabados/','/efe/','/buffet/','/chat/','/admin/'];
